...
fun Plan.findDay(dayId: String) = days.find { it.id == dayId }

fun Plan.findExercise(exerciseId: String) =
    days.flatMap { it.exercises }.find { it.id == exerciseId }

fun Plan.changeExercisesOrder(fromId: String, toId: String) = copy(
    days = days.map { day ->
